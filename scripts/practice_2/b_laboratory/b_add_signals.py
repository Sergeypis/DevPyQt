...
class Window(QtWidgets.QWidget):
    ...
    def initUi(self) -> None:
        ...
        self.plainTextEdit.setPlaceholderText("Введите текст в plainTextEdit ")
    ...
    def spinBoxTextChanged(self):
        """
        Обработка сигнала TextChanged для spinBox

        :return: None
        """
        self.plainTextEditLog.insertPlainText(self.spinBox.text())

    def dateTimeEditDateTimeChanged(self):
        """
